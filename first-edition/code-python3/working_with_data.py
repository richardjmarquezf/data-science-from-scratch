...
if __name__ == "__main__":
    ...
    with open("/home/richard/data-science-from-scratch/first-edition/code-python3/comma_delimited_stock_prices.csv", "r", encoding='utf8', newline='') as f:
        reader = csv.reader(f)
    ...
    print("stocks")
    with open("/home/richard/data-science-from-scratch/first-edition/code-python3/stocks.txt", "r", encoding='utf8', newline='') as f:
